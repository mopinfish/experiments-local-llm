...
#### 6.3.1 渋谷エリア（20件）- 既存テストから厳選

既存の55件から代表的な20件を選定（各レベル4件）。既存テストの`test_id`との対応を記録する。
...
# L2: 空間推論（4件）
"新宿駅に最も近いコンビニはどれですか？"
"新宿駅から500m以内にカフェは何件ありますか？"
"新宿駅の東側と西側、どちらに飲食店が多いですか？"
"新宿駅から最も遠い飲食店はどこですか？"

# L3: 制約充足（4件）
"新宿駅周辺で24時間営業のコンビニは？"
"新宿駅から300m以内でWi-Fiが使えるカフェは？"
"新宿駅周辺のスターバックスを全て教えてください"
"新宿で深夜営業しているバーはありますか？"

# L4: 意思決定支援（4件）
"新宿駅周辺でランチにおすすめの場所は？"
"新宿駅から近い順にカフェを3つ教えてください"
"新宿駅周辺で最もPOI密度が高いカテゴリは？"
"新宿駅の北側エリアで食事できる場所を探しています"

# L5: 高度推論（4件）
"新宿駅周辺のカフェの平均距離と最寄り・最遠のカフェの距離差は？"
"新宿駅500m圏と1km圏でPOIカテゴリの構成比はどう変わりますか？"
"新宿駅周辺でコンビニの競合状況を分析してください"
"新宿駅から最も近いカフェと、そこから300m以内の他カフェ数は？"
```

#### 6.3.3 池袋・東京エリア（各20件）

新宿と同様の構造で、エリア固有のランドマーク・特性を反映したテストケースを作成。

**池袋**: サンシャインシティ、池袋西口公園、東武百貨店 等
**東京**: 東京駅丸の内口、KITTE、皇居前 等
